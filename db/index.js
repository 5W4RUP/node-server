...
mongoose
   // .connect('mongodb://127.0.0.1:27017/notify-app',{useUnifiedTopology: true}).then(() => console.log('DB connection successful!'))
    .connect('mongodb+srv://swarup:Montai@1919@cluster0.ycxfj7b.mongodb.net/notify_app?retryWrites=true&w=majority',{ useNewUrlParser: true, useUnifiedTopology: true}).then(() => console.log('DB connection successful!'))
